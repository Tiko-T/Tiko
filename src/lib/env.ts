...
const rawEnvSchema = z.object({
  ...
  FAUCET_ENABLED: z.coerce.boolean().default(true),
  FAUCET_SINGLE_CLAIM_AMOUNT: z.coerce.number().int().min(1).default(50),
  FAUCET_MAX_PER_WALLET: z.coerce.number().int().min(1).default(200),
